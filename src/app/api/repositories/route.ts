...
async function buildRegistrationDependencies(
  ...
  let getForgeToken: ((userId: string, instanceUrl: string) => Promise<{ token: string; identityId: string } | null>) | undefined;
  if (input.provider === "gitlab") {
    ...
    forgeIdentity = pat === null ? null : { instanceUrl: normalized, token: pat.token };
